...
def handle_messages(ch, method, propr, body):
    try:
        channel.basic_publish(exchange="managerC_exchange", routing_key=method.routing_key, body= body)
...
if __name__ == '__main__':
    ...
    # Create the exchange to publish the received msgs
    channel.exchange_declare(exchange='managerC_exchange', exchange_type='topic')
